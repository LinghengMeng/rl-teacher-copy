...
from rl_teacher.envs import make_with_torque_removed, make_bullet_task
...
def main():
    ...
    parser.add_argument('-l', '--n_labels', default=1400, type=int)
    ...
    if args.predictor == "rl":
        ...
        pretrain_segments = segments_from_rand_rollout(
            env_id, make_bullet_task, n_desired_segments=pretrain_labels * 2,
    ...
    if args.agent == "parallel_trpo":
        train_parallel_trpo(
            env_id=env_id,
            make_env=make_bullet_task,
            predictor=predictor,
            summary_writer=summary_writer,
            workers=args.workers,
            runtime=-1,  # runtime=(num_timesteps / 1000),
        ...
        def make_env():
            return make_bullet_task(env_id)
